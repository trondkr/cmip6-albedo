...
class Config_albedo():
    ...
    def __init__(self):
        ...
        self.experiment_ids = ["ssp585"]
        self.source_ids = ["CMCC-ESM2","UKESM1-O-LL","CanESM5-CanOE] # ["CanESM5-CanOE","UKESM1-O-LL"] #["UKESM1-0-LL","MPI-ESM1-2-LR"] #["MPI-ESM1-2-HR"] #["ACCESS-ESM1-5"] #,"MPI-ESM1-2-HR"] #,"UKESM1-0-LL","MPI-ESM1-2-LR","CanESM5"] #,"MPI-ESM1-2-HR","UKESM1-0-LL"] #,"UKESM1-0-LL","CanESM5"]
